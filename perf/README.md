...
Loading and import messages cycle through one, two, and three dots (static with
reduced motion enabled). Identical Base and Head import messages appear only once.
