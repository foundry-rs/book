...
if (args.has("--help")) {
  console.log(`Usage:
  pnpm exec tsx scripts/check-cheatcode-coverage.ts
  pnpm exec tsx scripts/check-cheatcode-coverage.ts --refresh --spec <path> --commit <sha>
  pnpm exec tsx scripts/check-cheatcode-coverage.ts --accept-current
