...
export const cmdReference: SidebarItem[] = [
  { text: "Overview", link: "/reference/cheatcodes/overview" },
  {
    ...
    items: [
      ...
      { text: "cloneAccount", link: "/reference/cheatcodes/clone-account" },
      { text: "dumpState", link: "/reference/cheatcodes/dump-state" },
      { text: "loadAllocs", link: "/reference/cheatcodes/load-allocs" },
      ...
      { text: "mappingRecording", link: "/reference/cheatcodes/mapping-recording" },
      ...
      { text: "broadcastRawTransaction", link: "/reference/cheatcodes/broadcast-raw-transaction" },
      ...
      { text: "getStorageSlots", link: "/reference/cheatcodes/get-storage-slots" },
  ...
  },
  {
    ...
    items: [
      ...
      { text: "expectEmitAnonymous", link: "/reference/cheatcodes/expect-emit-anonymous" },
      ...
      {
        text: "expectKeychainAdminVerified",
        link: "/reference/cheatcodes/expect-keychain-admin-verified",
      },
      {
        text: "expectTip20LogoURIUpdated",
        link: "/reference/cheatcodes/expect-tip20-logo-uri-updated",
      },
    ],
  },
  {
    ...
    items: [
      ...
      { text: "bound", link: "/reference/cheatcodes/bound" },
    ],
  },
  {
    text: "Forking",
  ...
  },
  {
    ...
    items: [
      ...
      { text: "deployCode", link: "/reference/cheatcodes/deploy-code" },
      { text: "getSelectors", link: "/reference/cheatcodes/get-selectors" },
      ...
      { text: "parseJsonArrayLength", link: "/reference/cheatcodes/parse-json-array-length" },
      { text: "parseToml", link: "/reference/cheatcodes/parse-toml" },
      { text: "parseJsonKeys", link: "/reference/cheatcodes/parse-json-keys" },
      { text: "parseJsonType", link: "/reference/cheatcodes/parse-json-type" },
      { text: "parseJsonTypeArray", link: "/reference/cheatcodes/parse-json-type-array" },
      { text: "parseTomlKeys", link: "/reference/cheatcodes/parse-toml-keys" },
      { text: "serializeJson", link: "/reference/cheatcodes/serialize-json" },
      { text: "serializeJsonType", link: "/reference/cheatcodes/serialize-json-type" },
  ...
  },
  {
    ...
    items: [
      ...
      { text: "computeCreateAddress", link: "/reference/cheatcodes/compute-create-address" },
      { text: "computeCreate2Address", link: "/reference/cheatcodes/compute-create2-address" },
      ...
      { text: "getWallets", link: "/reference/cheatcodes/get-wallets" },
      ...
      { text: "randomUint", link: "/reference/cheatcodes/random-uint" },
      { text: "randomInt", link: "/reference/cheatcodes/random-int" },
      { text: "randomAddress", link: "/reference/cheatcodes/random-address" },
      ...
      { text: "eip712HashStruct", link: "/reference/cheatcodes/eip712-hash-struct" },
      { text: "eip712HashTypedData", link: "/reference/cheatcodes/eip712-hash-typed-data" },
      { text: "Strings", link: "/reference/cheatcodes/strings" },
      { text: "toBase64", link: "/reference/cheatcodes/to-base64" },
    ],
  },
