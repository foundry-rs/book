...
Paths to a solc binary are also accepted. To use a specific local solc binary, set set path as `solc = "<path to solc>"` in your config file or pass `--use "<path to solc>"`.
