...
This chapter will walk you through using `forge`, the command-line tool that tests, builds, and deploys your smart contracts.

- [Creating a New Project](./creating-a-new-project.md)
- [Working on an Existing Project](./working-on-an-existing-project.md)
- [Dependencies](./dependencies.md)
- [Project Layout](./project-layout.md)
- [Configuring with `foundry.toml`](./config.md)
- [Tests](./tests.md)
