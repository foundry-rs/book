...
Generate and upload coverage reports. See [Code Coverage](/guides/coverage) for profile configuration, source filters, LCOV versions, and per-test attribution:
