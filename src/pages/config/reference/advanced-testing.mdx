...
| [`tx_generator`](/config/reference/testing#tx_generator) | invariant | `rng` | Selects local RNG or opt-in mixed RNG/Jev Choices with ABI-derived view relationships. |
