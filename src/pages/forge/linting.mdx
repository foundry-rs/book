...
- [`optimism-deprecation`](/forge/linting/optimism-deprecation) — Flags usage of Optimism predeploy addresses removed in the Bedrock upgrade and GasPriceOracle functions that revert unconditionally post-Ecotone.
