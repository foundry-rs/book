...
- [`unsafe-oz-erc721-mint`](/forge/linting/unsafe-oz-erc721-mint) — Flags calls that resolve to `ERC721._mint`, which credits a token without checking that the recipient can receive it.
