...
Foundry keeps the workflow details here and links to Tempo's [TIP-20 docs](https://tempo.xyz/developers/docs/protocol/tip20/overview), [virtual-address docs](https://tempo.xyz/developers/docs/protocol/tip20/virtual-addresses), and [TIP-1022](https://tempo.xyz/developers/docs/protocol/tips/tip-1022) for protocol semantics.
...
For support and protocol details, see the Tempo [TIP-403 overview](https://tempo.xyz/developers/docs/protocol/tip403/overview), [TIP-403 specification](https://tempo.xyz/developers/docs/protocol/tip403/spec), [receive-policy docs](https://tempo.xyz/developers/docs/protocol/tip403/receive-policies), [receive-policy guide](https://tempo.xyz/developers/docs/guide/payments/configure-receive-policies), and [TIP-1028](https://tips.sh/1028).
...
For protocol context, see Tempo's [AccountKeychain docs](https://tempo.xyz/developers/docs/protocol/transactions/AccountKeychain), [TIP-1011](https://tempo.xyz/developers/docs/protocol/tips/tip-1011), and [TIP-1049](https://tips.sh/1049).
...
- Tempo transactions: [`cast send`](/reference/cast/send), [`cast mktx`](/reference/cast/mktx), [`cast batch-send`](/reference/cast/batch-send), [`cast classify`](/reference/cast/classify), [`cast channel-id`](/reference/cast/channel-id).
...
- Accounts and signing: [`cast tempo login`](/reference/cast/tempo/login), [`cast keychain`](/reference/cast/keychain), [`cast key-authorization`](/reference/cast/key-authorization), [`cast wallet session create`](/reference/cast/wallet/session/create).
