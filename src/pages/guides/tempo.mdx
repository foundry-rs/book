...
- [`setTip20LogoURI`](/reference/cheatcodes/set-tip20-logo-uri) and [`setLogoURI`](/reference/cheatcodes/set-logo-uri) set a TIP-20 token logo URI directly in storage.
- [`expectTip20LogoURIUpdated`](/reference/cheatcodes/expect-tip20-logo-uri-updated) and [`expectLogoURIUpdated`](/reference/cheatcodes/expect-logo-uri-updated) assert the TIP-20 logo update event.
