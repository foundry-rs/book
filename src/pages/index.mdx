...
```
  ...
  <HomePage.Description children="Foundry is a fast, portable, and modular toolkit for Ethereum application development written in Rust. Build, test, debug, deploy, and verify smart contracts with ease." />
  <HomePage.Buttons>
