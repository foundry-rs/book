---
description: "Get the EIP-7928 block access list of a block Examples: - cast bal latest - cast bal 21000000 --raw"
---

_Generated from `cast bal --help`; see [CLI reference versions](/reference/versions). Regenerate this page instead of editing it directly._
