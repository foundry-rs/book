...
Commands:
  ...
  eip712             Generate EIP-712 struct encodings for structs from a
                         given file
  flatten            Flatten a source file and all of its imports into one
                         file [aliases: f]
  fmt                Format Solidity source files
  geiger             Detects usage of unsafe cheat codes in a project and
                         its dependencies
  ...
  remappings         Get the automatically inferred remappings for the
                         project [aliases: re]
  ...
  tree               Display a tree visualization of the project's
                         dependency graph [aliases: tr]
