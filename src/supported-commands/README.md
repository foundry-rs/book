...
| forge verify-check                  | ✅ Supported     | Checks the verification status of a contract on a blockchain explorer for ZKsync block explorer, confirming that it has been successfully verified. |
