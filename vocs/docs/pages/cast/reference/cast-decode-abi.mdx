...
By default, the command will decode output data. To decode input data, pass `--input` or use [`cast decode-calldata`](/reference/cast/cast-decode-calldata.mdx).
...
[cast](/reference/cast/cast.mdx), [cast decode-calldata](/reference/cast/cast-decode-calldata.mdx)
