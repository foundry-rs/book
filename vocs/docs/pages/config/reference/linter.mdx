...
To disable linting on build entirely, in your `foundry.toml` set:
...
We are continuously improving the linter to provide better feedback and catch more issues.
