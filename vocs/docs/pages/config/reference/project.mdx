...
See the [Configuration Inheritance](/guides/project-setup/project-layout#configuration-inheritance) section for detailed information about merge strategies, precedence rules, and examples.
