...
take file filters (e.g. [forge test](/reference/forge/forge-test.mdx)), sparse mode will only recompile files that match the filter.
...
[forge](/reference/forge/forge.mdx), [forge clean](/reference/forge/forge-clean.mdx), [forge inspect](/reference/forge/forge-inspect.mdx), [sparse-mode](/reference/config/solidity-compiler.mdx#sparse_mode), [ir-pipeline](https://docs.soliditylang.org/en/latest/ir-breaking-changes.html), [output-desc](https://docs.soliditylang.org/en/latest/using-the-compiler.html#compiler-api)
