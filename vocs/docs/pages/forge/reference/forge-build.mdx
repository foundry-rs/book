...
[forge](/forge/reference/overview), [forge clean](/forge/reference/forge-clean.mdx), [forge inspect](/forge/reference/forge-inspect.mdx), [sparse-mode](/reference/config/solidity-compiler.mdx#sparse_mode), [ir-pipeline](https://docs.soliditylang.org/en/latest/ir-breaking-changes.html), [output-desc](https://docs.soliditylang.org/en/latest/using-the-compiler.html#compiler-api)
