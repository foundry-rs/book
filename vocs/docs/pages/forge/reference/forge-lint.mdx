...
Alternatively, you can also disable this individual occurence using [inline configuration](/config/lint/#inline-configuration).
...
Alternatively, you can also disable this individual occurence using [inline configuration](/config/lint/#inline-configuration).
You can also disable this lint using [inline configuration](#inline-config).
