...
(Note that [cache](/reference/config/project) must be enabled in the config for the latter to work.)
...
[forge](/forge/reference/forge.mdx), [forge create](/forge/reference/forge-create.mdx), [forge flatten](/forge/reference/forge-flatten.mdx), [forge verify-check](/forge/reference/forge-verify-check.mdx)
