...
To start a new project with Foundry, use the [`forge init`](/reference/forge/forge-init) command:
...
You can compile the project using [`forge build`](/reference/forge/forge-build):
...
To run the tests, use the [`forge test`](/reference/forge/forge-test) command:
