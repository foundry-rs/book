...
This guide provides a structured prompt template for developers who want to use AI assistants to build smart contracts with Foundry. Copy and customize this prompt to get the most effective out of AI assistants while using foundry's tools.

## Structured Foundry Prompt

Use this comprehensive prompt when working with AI assistants on smart contract projects:
...
2. **Replace `{user_prompt}`** at the bottom with your specific question or request
3. **Customize sections** as needed for your project requirements
...
```text
<user_prompt>
I need to create a yield farming vault contract with the following features:
...
## Benefits of This Structured Prompt

- **Comprehensive Coverage**: Includes all Foundry tools and advanced testing methodologies
- **Security Focus**: Emphasizes security patterns, linting, and comprehensive testing
- **Advanced Testing**: Covers fuzz testing, invariant testing with handlers, and EIP-712
- **Practical Workflows**: Provides real-world development and deployment patterns
- **Performance Optimization**: Includes dynamic test linking and other optimization techniques
- **Professional Standards**: Enforces proper naming conventions and code organization
