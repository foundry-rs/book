...
Below is an extensive example prompt that can help you build secure, well-tested smart contracts using Foundry and your preferred AI model.
...
3. Make sure to enter your specific requirements at the end between the `<user_prompt>` and `</user_prompt>` tags
...
You can customize sections of the prompt as needed for your specific project requirements. The prompt is designed to be comprehensive but can be tailored to focus on particular areas like testing, deployment, or specific Foundry tools.
