...
- `Vm.sol`: Up-to-date [cheatcodes interface](/reference/cheatcodes/README#cheatcodes-interface)
...
- `Script.sol`: Basic utilities for [Solidity scripting](#TODO)
...
- A cheatcodes instance `vm`, from which you invoke Forge cheatcodes (see [Cheatcodes Reference](/reference/cheatcodes/README))
