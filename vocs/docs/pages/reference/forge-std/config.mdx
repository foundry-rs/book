...
- **Numeric chain ID**: e.g., `[1]`, `[10]`, `[998]` - Works for any chain, including custom networks
- **Alloy chain alias**: e.g., `[mainnet]`, `[optimism]`, `[arbitrum_sepolia]` - Must match an exact alias from [Alloy chains](https://github.com/alloy-rs/chains/blob/main/src/named.rs)
