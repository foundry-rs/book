...
import MultiWalletOptions from "../common/multi-wallet-options.mdx";
...
2. Deploy a contract on Polygon [see the `Scripting with Solidity` guide for an example script](#TODO). _The verifier url is different for every network._
