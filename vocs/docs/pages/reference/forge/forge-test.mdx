...
[forge](/reference/forge/forge.mdx), [forge build](/reference/forge/forge-build.mdx), [forge snapshot](/reference/forge/forge-snapshot.mdx), [debugger](/reference/forge/debugger.mdx), [cheatcodes](/reference/cheatcodes), [gas-reports](/reference/forge/gas-reports.mdx)
