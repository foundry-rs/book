...
Forge will update to the latest version on the ref you specified for the dependency when you ran [`forge install`](/reference/forge/forge-install.mdx).
...
[forge](/reference/forge/forge.mdx), [forge install](/reference/forge/forge-install.mdx), [forge remove](/reference/forge/forge-remove.mdx)
