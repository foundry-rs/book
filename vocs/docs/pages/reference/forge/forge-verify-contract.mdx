...
[forge](/reference/forge/forge.mdx), [forge create](/reference/forge/forge-create.mdx), [forge flatten](/reference/forge/forge-flatten.mdx), [forge verify-check](/reference/forge/forge-verify-check.mdx)
