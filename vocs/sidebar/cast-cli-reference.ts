...
export const castCliReference: SidebarItem = {
  ...
  items: [
    { text: "cast", link: "/cast/reference/cast" },
    {
      ...
      items: [
        ...
        { text: "cast decode-abi", link: "/cast/reference/decode-abi" },
        {
          ...
          link: "/cast/reference/decode-calldata",
        },
        {
          text: "cast pretty-calldata",
          link: "/cast/reference/pretty-calldata",
        },
        { text: "cast selectors", link: "/cast/reference/selectors" },
        {
          text: "cast upload-signature",
          link: "/cast/reference/upload-signature",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          link: "/cast/reference/format-bytes32-string",
        },
        { text: "cast from-bin", link: "/cast/reference/from-bin" },
        {
          text: "cast from-fixed-point",
          link: "/cast/reference/from-fixed-point",
        },
        ...
        { text: "cast from-wei", link: "/cast/reference/from-wei" },
        {
          ...
          link: "/cast/reference/parse-bytes32-address",
        },
        {
          text: "cast parse-bytes32-string",
          link: "/cast/reference/parse-bytes32-string",
        },
    ...
    },
    {
      ...
      collapsed: true,
      items: [{ text: "cast source", link: "/cast/reference/source" }],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { text: "cast codehash", link: "/cast/reference/codehash" },
        {
          ...
          link: "/cast/reference/compute-address",
        },
        { text: "cast concat-hex", link: "/cast/reference/concat-hex" },
        {
          text: "cast constructor-args",
          link: "/cast/reference/constructor-args",
        },
        ...
        {
          text: "cast decode-transaction",
          link: "/cast/reference/decode-transaction",
        },
        { text: "cast disassemble", link: "/cast/reference/disassemble" },
        {
          text: "cast estimate --create",
          link: "/cast/reference/estimate/--create",
        },
        ...
        {
          text: "cast recover-authority",
          link: "/cast/reference/recover-authority",
        },
        ...
        { text: "cast storage-root", link: "/cast/reference/storage-root" },
        {
          ...
          link: "/cast/reference/to-check-sum-address",
        },
        { text: "cast to-utf8", link: "/cast/reference/to-utf8" },
        { text: "cast tx-pool", link: "/cast/reference/tx-pool" },
        {
          text: "cast tx-pool content",
          link: "/cast/reference/tx-pool/content",
        },
        {
          text: "cast tx-pool content-from",
          link: "/cast/reference/tx-pool/content-from",
        },
        {
          text: "cast tx-pool inspect",
          link: "/cast/reference/tx-pool/inspect",
        },
        { text: "cast tx-pool status", link: "/cast/reference/tx-pool/status" },
        { text: "cast wallet address", link: "/cast/reference/wallet/address" },
        {
          text: "cast wallet change-password",
          link: "/cast/reference/wallet/change-password",
        },
        {
          text: "cast wallet decrypt-keystore",
          link: "/cast/reference/wallet/decrypt-keystore",
        },
        ...
        { text: "cast wallet new", link: "/cast/reference/wallet/new" },
        {
          ...
          link: "/cast/reference/wallet/new-mnemonic",
        },
        {
          text: "cast wallet private-key",
          link: "/cast/reference/wallet/private-key",
        },
        {
          text: "cast wallet public-key",
          link: "/cast/reference/wallet/public-key",
        },
        ...
        { text: "cast wallet sign", link: "/cast/reference/wallet/sign" },
        {
          ...
          link: "/cast/reference/wallet/sign-auth",
        },
    ...
    },
    {
      ...
      collapsed: true,
      items: [{ text: "cast wallet", link: "/cast/reference/wallet" }],
    },
  ],
};
