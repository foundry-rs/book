    ...
    items: [
      { text: "Std Logs", link: "/reference/forge-std/std-logs" },
      {
        ...
        items: [
          ...
          {
            text: "assertApproxEqAbsDecimal",
            link: "/reference/forge-std/assertApproxEqAbsDecimal",
          },
          { text: "assertApproxEqRel", link: "/reference/forge-std/assertApproxEqRel" },
          {
            text: "assertApproxEqRelDecimal",
            link: "/reference/forge-std/assertApproxEqRelDecimal",
          },
        ],
      },
      {
