  ...
  items: [
    ...
    },
    {
      ...
      items: [
        ...
        { text: "forge verify-contract", link: "/forge/reference/verify-contract" },
      ],
    },
    {
      text: "General Commands",
      collapsed: true,
      items: [{ text: "forge completions", link: "/forge/reference/completions" }],
    },
    {
      ...
      items: [
        ...
        { text: "forge soldeer install", link: "/forge/reference/soldeer/install" },
        { text: "forge soldeer update", link: "/forge/reference/soldeer/update" },
    ...
    },
    {
      ...
      items: [
        ...
        { text: "forge compiler resolve", link: "/forge/reference/compiler/resolve" },
        ...
        { text: "forge selectors collision", link: "/forge/reference/selectors/collision" },
        { text: "forge selectors find", link: "/forge/reference/selectors/find" },
        { text: "forge selectors list", link: "/forge/reference/selectors/list" },
        { text: "forge selectors upload", link: "/forge/reference/selectors/upload" },
