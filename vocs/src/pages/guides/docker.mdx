...
```bash [~/.bashrc]
$ alias dforge='docker run --rm -v $(pwd):/app -w /app ghcr.io/foundry-rs/foundry forge' # [!code hl]
$ alias dcast='docker run --rm ghcr.io/foundry-rs/foundry cast' # [!code hl]
$ alias danvil='docker run --rm -p 8545:8545 ghcr.io/foundry-rs/foundry anvil --host 0.0.0.0' # [!code hl]
```
...
```bash
$ docker run --rm -p 8545:8545 ghcr.io/foundry-rs/foundry anvil --host 0.0.0.0 # [!code hl]
```
